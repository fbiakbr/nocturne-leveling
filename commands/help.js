...
const prefix = config.prefix
    ...
    let help = new MessageEmbed()
      ...
      .addFields(
        { name: `Leveling Command`, value: `\`${prefix}leaderboard\`, \`${prefix}role-level\`, \`${prefix}add-level\`, \`${prefix}blacklist\`, \`${prefix}levelupmessage\`, \`${prefix}xpsettings\`, \`${prefix}channel-levelup\``},
      )
      .addFields(
        { name: `Configuration Command`, value: `\`${prefix}set-prefix\``},
      )
      .setTimestamp()
      .setFooter('UPT - Nocturne');
